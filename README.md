...
- 浏览器日语语音负责朗读题目。
- 共 383 道：93 个 Script 高频词、71 个对话词汇、76 个 tutorial 句子、38 个片假名单词、32 个 lecture 核心句式、59 个数字表达和 14 个补充词。
...
- 片假名题库：W4 Script 四组正式练习词 30 个，加上 8 个常见补充词；范围包含ト之后的字符、浊音、长音和促音。
