# JPNS1611 Kana and Grammar Dictation App

一份根据 JPNS1611 Week 1–4 tutorial 与 lecture slides 整理的离线假名及句式听写练习。
...
- 浏览器日语语音负责朗读题目。
- 共 365 道：93 个 Script 高频词、71 个对话词汇、76 个 tutorial 句子、20 个片假名单词（覆盖 A–TO）、32 个 lecture 核心句式、59 个数字表达和 14 个补充词。
- 片假名单词采用严格字形判定，写成平假名不会算正确；题面只显示中文或罗马字提示。
...
- Week 1–4 Script slides
- Week 1–4 Communication tutorial slides
- Week 1–4 Grammar lecture slides
- 片假名范围：用 20 个完整单词覆盖 A–TO；其中 12 个来自 W4 Script，8 个为常见补充词。
