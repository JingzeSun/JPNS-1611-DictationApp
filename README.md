...
- 浏览器日语语音负责朗读题目。
- 共 365 道：93 个 Script 高频词、71 个对话词汇、76 个 tutorial 句子、20 个片假名（ア–ト）、32 个 lecture 核心句式、59 个数字表达和 14 个补充词。
- 片假名输入题采用严格字形判定，写成对应平假名不会算正确。
...
- 课堂指定片假名范围：ア、イ、ウ、エ、オ、カ、キ、ク、ケ、コ、サ、シ、ス、セ、ソ、タ、チ、ツ、テ、ト
